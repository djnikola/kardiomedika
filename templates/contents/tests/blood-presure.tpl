...
<table border="0" cellspacing="0" cellpadding="0" width="500">
	<tr>
		...
		<td>
			<input id="name" name="data[first_name]" value="{[$first_name]}" class="input_field" maxlength="30" size="20" {[if isset($errors.first_name) && $errors.first_name ==1 ]}style="border-color:red;"{[/if]}/>
		</td>
	</tr>
	<tr>
		<th align="left">
		...
		<td>
			<input id="name" name="data[last_name]" value="{[$last_name]}" class="input_field" maxlength="30" size="20" {[if isset($errors.last_name) && $errors.last_name ==1 ]}style="border-color:red;"{[/if]}/>
		</td>
	</tr>
	<tr>
		<th align="left">
		...
		<td>
			<input id="name" name="data[birth_year]" value="{[$birth_year]}" class="input_field" maxlength="4" size="4" {[if isset($errors.birth_year) && $errors.birth_year ==1 ]}style="border-color:red;"{[/if]}/>
		</td>
	</tr>
	<tr>
		<th align="left">
		...
		<td>
			<input id="name" name="data[phone]" value="{[$phone]}" class="input_field"  {[if isset($errors.phone) && $errors.phone ==1 ]}style="border-color:red;"{[/if]}/>
		</td>
	</tr>
	<tr>
		<th align="left">
		...
		<td>
			<input id="name" name="data[email]" value="{[$email]}" class="input_field"/>
		</td>
	</tr>
...
{[foreach from=$messure key=iteration item=v]}
<tr style="{border:2px solid #ff0000;}">
	<td  bgcolor={[if $iteration == 1]}"yellow"{[else]}"#EFF3F4"{[/if]} rowspan="3">{[$iteration]}. dan <input class="date" id="day_{[$iteration]}" name="messure[{[$iteration]}][day]" value="{[$v.day]}"/></td>
	<td  bgcolor={[if $iteration == 1]}"yellow"{[else]}"#EFF3F4"{[/if]}><label>Jutro:</label><input class="hour" id="morning_time_{[$iteration]}" name="messure[{[$iteration]}][morning_time]" value="{[$v.morning_time]}"/> h</td>
	<td  bgcolor={[if $iteration == 1]}"yellow"{[else]}"#EFF3F4"{[/if]}><input class="preasure" id="morning_upper_{[$iteration]}" name="messure[{[$iteration]}][morning_upper]" value="{[$v.morning_upper]}"/></td>
	<td  bgcolor={[if $iteration == 1]}"yellow"{[else]}"#EFF3F4"{[/if]}><input class="preasure" id="morning_down_{[$iteration]}" name="messure[{[$iteration]}][morning_down]" value="{[$v.morning_down]}"/></td>
	<td  bgcolor={[if $iteration == 1]}"yellow"{[else]}"#EFF3F4"{[/if]}><input class="puls" id="morning_puls_{[$iteration]}" name="messure[{[$iteration]}][morning_puls]" value="{[$v.morning_puls]}"/></td>
	<td  bgcolor={[if $iteration == 1]}"yellow"{[else]}"#EFF3F4"{[/if]}><input class="comment" id="morning_comments_{[$iteration]}" name="messure[{[$iteration]}][morning_comments]" value="{[$v.morning_comments]}"/></td>
</tr>
<tr>
	<td  bgcolor={[if $iteration == 1]}"yellow"{[else]}"#EFF3F4"{[/if]}><label>&nbsp;</label><input class="hour" id="afternoon_time_{[$iteration]}" name="messure[{[$iteration]}][afternoon_time]" value="{[$v.afternoon_time]}"/> h</td>
	<td  bgcolor={[if $iteration == 1]}"yellow"{[else]}"#EFF3F4"{[/if]}><input class="preasure" id="afternoon_upper_{[$iteration]}" name="messure[{[$iteration]}][afternoon_upper]" value="{[$v.afternoon_upper]}"/></td>
	<td  bgcolor={[if $iteration == 1]}"yellow"{[else]}"#EFF3F4"{[/if]}><input class="preasure" id="afternoon_down_{[$iteration]}" name="messure[{[$iteration]}][afternoon_down]" value="{[$v.afternoon_down]}"/></td>
	<td  bgcolor={[if $iteration == 1]}"yellow"{[else]}"#EFF3F4"{[/if]}><input class="puls" id="afternoon_puls_{[$iteration]}" name="messure[{[$iteration]}][afternoon_puls]" value="{[$v.afternoon_puls]}"/></td>
	<td  bgcolor={[if $iteration == 1]}"yellow"{[else]}"#EFF3F4"{[/if]}><input class="comment" id="afternoon_comments_{[$iteration]}" name="messure[{[$iteration]}][afternoon_comments]" value="{[$v.afternoon_comments]}"/></td>
</tr>
<tr>
	<td  bgcolor={[if $iteration == 1]}"yellow"{[else]}"#EFF3F4"{[/if]}><label>Veče:</label><input class="hour" id="evening_time_{[$iteration]}" name="messure[{[$iteration]}][evening_time]" value="{[$v.evening_time]}"/> h</td>
	<td  bgcolor={[if $iteration == 1]}"yellow"{[else]}"#EFF3F4"{[/if]}><input class="preasure" id="evening_upper_{[$iteration]}" name="messure[{[$iteration]}][evening_upper]" value="{[$v.evening_upper]}"/></td>
	<td  bgcolor={[if $iteration == 1]}"yellow"{[else]}"#EFF3F4"{[/if]}><input class="preasure" id="evening_down_{[$iteration]}" name="messure[{[$iteration]}][evening_down]" value="{[$v.evening_down]}"/></td>
	<td  bgcolor={[if $iteration == 1]}"yellow"{[else]}"#EFF3F4"{[/if]}><input class="puls" id="evening_puls_{[$iteration]}" name="messure[{[$iteration]}][evening_puls]" value="{[$v.evening_puls]}"/></td>
	<td  bgcolor={[if $iteration == 1]}"yellow"{[else]}"#EFF3F4"{[/if]}><input class="comment" id="evening_comments_{[$iteration]}" name="messure[{[$iteration]}][evening_comments]" value="{[$v.evening_comments]}"/></td>
</tr>
{[/foreach]}
<tr>
...
Formular <strong>"Dnevnik krvnog pritiska"</strong> možete preuzeti i <a href="{[$baseUrl]}Dnevnik-krvnog-pritiska.pdf" target="_blank"><strong>ovde</strong></a>.
</form>