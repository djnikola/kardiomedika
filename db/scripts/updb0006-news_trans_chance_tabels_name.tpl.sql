RENAME TABLE `news_trans` TO `articles_trans` ;
...
trim(both '$' from '$HeadURL: svn+sshp://radisa.no-ip.info/repos/webteam/genesis/branches/frisco/db/scripts/updb0006-news_trans_chance_tabels_name.tpl.sql $'),'/',-1),     
