<?php
	...
	$mcFileManagerConfig['filesystem.path'] = '../../../../uploads'; // absolute or relative from this script path.
	...
	$mcFileManagerConfig['filesystem.extensions'] = "gif,jpg,jpeg,htm,html,pdf,zip,txt,css";
	...
	$mcFileManagerConfig['upload.extensions'] = "gif,jpg,jpeg,htm,html,pdf,txt,zip,css";
	...
	$mcFileManagerConfig['download.extensions'] = "gif,jpg,jpeg,htm,html,pdf,txt,zip.css";
	...
	$mcFileManagerConfig['authenticator'] = "CSAuthenticatorImpl";
