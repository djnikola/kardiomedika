...
/* if it is larger than max_image_width*max_image_height resize keeping aspect ratio */
$max_image_width = 160;
$max_image_height = 60;
...
if ($r_image_width > $max_image_width) {
    $r_image_width = $max_image_width;
    $r_image_height = ($image_height * $r_image_width) / $image_width;
    error_log("Resizing x $image_width $image_height $r_image_width $r_image_height");
}
error_log("Resizing x after $image_width $image_height $r_image_width $r_image_height");



if ($r_image_height > $max_image_height) {
    $r_image_height = $max_image_height;
    $r_image_width = ($r_image_height * $image_width) / $image_height;

    error_log("Resizing y $image_width $image_height $r_image_width $r_image_height");
}
error_log("Resizing y after $image_width $image_height $r_image_width $r_image_height");

$image_p = imagecreatetruecolor($r_image_width, $r_image_height);
imagecopyresampled($image_p, $im, 0, 0, 0, 0, $r_image_width, $r_image_height, $image_width, $image_height);
